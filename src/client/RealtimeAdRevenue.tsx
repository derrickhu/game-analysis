...
const SCENE_LABELS: Record<string, Record<string, string>> = {
  ...
  xiaochu: {
    ...
    signDouble: '每日签到 - 奖励翻倍',
    daily_sign: '每日签到 - 奖励翻倍',
    dailyTaskBonus: '每日任务 - 全部完成奖励翻倍',
    daily_task_all_bonus: '每日任务 - 全部完成奖励翻倍',
    newbieFirstClearDouble: '新手首通 - 奖励翻倍',
    stage_1_1_first_clear: '新手首通 - 奖励翻倍',
    settleDouble: '结算页 - 奖励翻倍',
    stage_boss_clear: '主线 Boss 关 - 结算奖励翻倍',
    staminaRefund: '关卡失败 - 退还体力',
    stage_defeat_refund: '关卡失败 - 退还体力',
    dexMilestone: '图鉴里程碑 - 奖励翻倍',
    dexAcquireHint: '图鉴详情 - 获取提示',
    towerExtraRun: '通天塔 - 额外挑战次数',
    towerItem: '通天塔 - 局内灵宝',
    towerBenchUnlock: '通天塔 - 解锁候补位',
